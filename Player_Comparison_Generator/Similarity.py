...
test_data = [30,900,8.1,15.5,.524,6.1,10.9,.563,2.0,4.6,.433,6.8,9.1,.755,11.8,3.2,2.8,2.7,25.1]
...
Similarity(test_data, sql.read_from_db())
Similarity(test_data2, sql.read_from_db())
sql.c.close()
sql.conn.close()
